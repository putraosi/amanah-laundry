...
import { Clock, FileText, Sparkles, Truck } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-primary/10 to-background py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Nikmati layanan laundry berkualitas dengan sistem kwitansi digital
            yang mudah dibagikan via WhatsApp
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg">
              Pilihan layanan yang sesuai dengan kebutuhan Anda
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Layanan lengkap cuci dan setrika
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow border-primary/50">
              <CardHeader>
                ...
                <CardDescription>
                  Layanan cepat untuk kebutuhan mendesak
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Layanan ongkir untuk kenyamanan Anda
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-bold text-primary mb-2">
      ...
      <section className="py-20 px-4 bg-primary/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-muted-foreground text-lg mb-8">
            Sistem kwitansi modern yang bisa langsung dibagikan ke pelanggan via
            WhatsApp
          </p>
          <Button asChild size="lg" className="text-lg">
            <Link to="/receipt">
      ...
      <footer className="py-8 px-4 border-t">
        <div className="max-w-6xl mx-auto text-center text-muted-foreground">
          <p>
            &copy; 2025 Amanah Laundry. Layanan terbaik untuk pakaian bersih
            Anda.
          </p>
        </div>
      </footer>
